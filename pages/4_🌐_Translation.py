...
if st.session_state.translation_result:
    ...
    with st.expander("🔬 Translation Technology Details"):
        st.markdown("""
        **Translation Model:** mBART (Multilingual BART)
        ...
        **Translation Approach:**
        - Pretrained multilingual neural machine translation
        - Contextual meaning preservation
        - Semantic accuracy maintained across languages
        - Scholarly interpretation
        - Cultural nuance consideration
        
        **Technology:** Facebook's mBART model fine-tuned for Sanskrit translation
